$(function() {
    ...
    getUserEmailAddress(function(userEmail, error) {
      if (error) {
        ...
        getUserInboxMessages(userEmail, function(messages, error){
          ...
          getMeetingTimes(userEmail, function(response, error) {
  ...
  function getMeetingTimes(emailAddress, callback) {
    getAccessToken(function(accessToken) {
      if (accessToken) {
        // Call the Outlook API
        var callOptions = {
          // Get messages from the inbox folder
          url: apiEndpoint + '/me/findmeetingtimes',
          token: accessToken,
          method: 'POST',
          email: emailAddress,
          query: {
           "Attendees": [
             {
               "Type": "Required",
               "EmailAddress": {
                 "Address": "rohit.funde@rakuten.com"
               }
             },  {
               "Type": "Required",
               "EmailAddress": {
                 "Address": "amit.nadiger@rakuten.com"
               }
             }
           ],
           "TimeConstraint": {
